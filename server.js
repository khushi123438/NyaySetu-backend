...
// Serve the front-end static files (serve the `pro/` directory)
...
// News proxy route (keeps previous behavior)
...
// Signup (multipart/form-data expected)
